  ...
  return (
    ...
    >
      ...
      <div className="w-full relative z-10" style={{ maxWidth: 400 }}>
        ...
        <div className="glass-card-light signup-card" style={{ padding: "24px 20px" }}>
          ...
          <p className="font-cairo font-light text-center" style={{ fontSize: 13, color: "hsl(var(--muted-foreground))", marginTop: 20 }}>
            عندك حساب؟{" "}
            <button onClick={() => navigate("/login")} className="font-cairo font-bold" style={{ background: "none", border: "none", color: "hsl(var(--primary))", cursor: "pointer", fontSize: 13, minHeight: 44 }}>
              سجل دخول
            </button>
          </p>
        </div>
      ...
      <style>{`
        @media (min-width: 1024px) {
          .signup-card { padding: 32px 28px !important; }
        }
      `}</style>
    </div>
  );
