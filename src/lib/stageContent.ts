...
export const STAGE_NODES = [
  ...
  { name: "متحدث", desc: "تخلص من كلمات الحشو", criteria: "٣ جلسات متتالية بأقل من ٤ كلمات حشو" },
  { name: "واضح", desc: "رتّب أفكارك", criteria: "٥ جلسات بنقاط تدفق أكثر من ٦٥" },
  { name: "مؤثر", desc: "تحت الضغط", criteria: "٥ تحديات مفاجئة بنتيجة أكثر من ٧٠" },
  { name: "خطيب", desc: "أي موضوع، أي غرفة", criteria: "٧ تحديات بنتيجة أكثر من ٧٠" },
